...
const extractTotalAmount = (text: string): string | null => {
  ...
  const totalKeywords = ['tong', 'total', 't.cong', 'cong', 'thanh toan', 'tien mat', 'amount', 'phai tra', 'vnd', 'd', 'payment', 'grand'];
  const ignoreKeywords = ['dt:', 'tel', 'phone', 'ngay', 'date', 'gio', 'time', 'mst', 'tax', 'ban:', 'table', 'khach', 'so:'];
